...
// -------------------------
const COLORS = {
  primary: "#193288",         // Sidebar background
  accent: "#001867ff",        // Active icon/text color
  button: "#FFC20E",          // Active tab background / button
  success: "#16a34a",
  warning: "#f59e0b",
  danger: "#dc2626",
  textDark: "#111827",
          ...
          <View style={{ flexDirection: screenWidth > 768 ? "row" : "column", gap: 16 }}>
            <View style={{ flex: 1, backgroundColor: "#fff", borderRadius: 16, padding: 16 }}>
              ...
              {leaderboardData.map((user, index) => (
                ...
                >
                  <Image
                    source={{ uri: `https://i.pravatar.cc/50?img=${index + 1}` }}
            ...
            <View style={{ flex: 1, backgroundColor: "#fff", borderRadius: 16, padding: 16 }}>
              ...
              {leaderboardData.map((user, index) => (
                ...
                >
                  <Image
                    source={{ uri: `https://i.pravatar.cc/50?img=${index + 5}` }}
                    style={{ width: 50, height: 50, borderRadius: 25, marginRight: 12 }}
                  />
                  <View style={{ flex: 1 }}>
                    <Text style={{ fontWeight: "600", fontSize: 16, color: COLORS.textDark }}>{user.name}</Text>
