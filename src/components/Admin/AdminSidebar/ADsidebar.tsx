...
export default function Sidebar({ mobile, open, onClose }: SidebarProps) {
  ...
  const menuItems = [
    { id: "ADDashboard", title: "Dashboard", icon: <LayoutDashboard size={20} color="#fff" /> },
    { id: "AdminAnalytic", title: "Analytics", icon: <BarChart3 size={20} color="#fff" /> },
    { id: "AdminShareholder", title: "Shareholder", icon: <Users size={20} color="#fff" /> },
    { id: "Adminpayrol", title: "Payroll", icon: <Wallet size={20} color="#fff" /> },
    { id: "AdminExpenses", title: "Expenses", icon: <Receipt size={20} color="#fff" /> },
    { id: "ADReport", title: "Reports", icon: <FileText size={20} color="#fff" /> },
    { id: "AdminFvrt", title: "Favourite", icon: <Star size={20} color="#fff" /> },
    { id: "AdminMessage", title: "Messages", icon: <MessageCircle size={20} color="#fff" />, badge: 1 },
    { id: "AdminHistory", title: "History", icon: <History size={20} color="#fff" /> },
    { id: "AdminSetting", title: "Settings", icon: <Settings size={20} color="#fff" /> },
  ];
