...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  const menuItems = [
    { id: "ShareholderDashboard", title: "Dashboard", icon: <LayoutDashboard size={20} color="#fff" /> },
    { id: "ShareholderAnalytic", title: "Analytics", icon: <BarChart3 size={20} color="#fff" /> },
    { id: "Shareholder", title: "Shareholder", icon: <Users size={20} color="#fff" /> },
    { id: "Shareholderpayrol", title: "Payroll", icon: <Wallet size={20} color="#fff" /> },
    { id: "Expenses", title: "Expenses", icon: <Receipt size={20} color="#fff" /> },
    { id: "ShareholderReport", title: "Reports", icon: <FileText size={20} color="#fff" /> },
    { id: "Shareholderfvrt", title: "Favourite", icon: <Star size={20} color="#fff" /> },
    { id: "ShareholderMessage", title: "Messages", icon: <MessageCircle size={20} color="#fff" />, badge: 1 },
    { id: "ShareholderHistory", title: "History", icon: <History size={20} color="#fff" /> },
    { id: "Shareholdersetting", title: "Settings", icon: <Settings size={20} color="#fff" /> },
  ];
